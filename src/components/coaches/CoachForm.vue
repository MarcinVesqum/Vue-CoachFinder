<template>
     <form @submit.prevent="submitForm">
        <div class="form-control" :class="{invalid: !firstName.isValid}" >
            ...
            <p v-if="!firstName.isValid">Fristname must not be empty.</p>
        </div>
        <div class="form-control" :class="{invalid: !lastName.isValid}" >
            <label for="lastName">last name</label>
            <input type="text" id="lastName" v-model.trim="lastName.val" @blur="clearValidity('lastName')" />
            <p v-if="!lastName.isValid">Fristname must not be empty.</p>
        </div>
        ...
        <div class="form-control" :class="{invalid: !rate.isValid}" >
            ...
            <p v-if="rate.val < 0">Rate must be greater than 0.</p>
        </div>
        <div class="from-control" :class="{invalid: !areas.isValid}">
            ...
            <p v-if="!areas.isValid">Areas of Expertise must not be empty.</p>
        </div>
